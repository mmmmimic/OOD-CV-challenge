...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # print(out_channels)
    if args.pretrained:
        model = timm.models.convnext_base(pretrained=True, num_classes=15)
    else:
        model = timm.models.convnext_base(pretrained=False, num_classes=15)
...
def save_checkpoint(state, is_best, filename='convnext15_checkpoint.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'convnext15_best.pth.tar')
